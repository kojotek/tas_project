...
using BiedaPL_BusAPI_Test.AuctionHouse;//do czeba dodawac!  tzn namespace mozna w servicecontract zmienic ServiceContract(Namespace="")  // kosmetyka, zostawic na koniec
