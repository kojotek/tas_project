...
public interface IBiedaService
{
    ...
    bool createAuction(string userLogin, string categoryName, string productName, string productDesc, decimal pricePerUnit, decimal priceDelivery, int lifeTimeDays);
    ...
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBiedaService/getOffers", ReplyAction="http://tempuri.org/IBiedaService/getOffersResponse")]
    string[] getOffers(int id_aukcji);
}
...
public partial class BiedaServiceClient : System.ServiceModel.ClientBase<IBiedaService>, IBiedaService
{
    ...
    public bool createAuction(string userLogin, string categoryName, string productName, string productDesc, decimal pricePerUnit, decimal priceDelivery, int lifeTimeDays)
    {
        return base.Channel.createAuction(userLogin, categoryName, productName, productDesc, pricePerUnit, priceDelivery, lifeTimeDays);
    }
    ...
    public string[] getOffers(int id_aukcji)
    {
        return base.Channel.getOffers(id_aukcji);
    }
}
