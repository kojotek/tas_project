...
public interface IBiedaService
{
    ...
    string[] getAuctions(string haslo, int kategoria, int sposob_sort, int rosnaco);
}
...
public partial class BiedaServiceClient : System.ServiceModel.ClientBase<IBiedaService>, IBiedaService
{
    ...
    public string[] getAuctions(string haslo, int kategoria, int sposob_sort, int rosnaco)
    {
